//! W3C Slidy presentation writer for rescribe.
//!
//! Generates W3C Slidy HTML presentations from rescribe's document IR.

use rescribe_core::{ConversionResult, Document, EmitError, EmitOptions, Node};
use rescribe_std::{node, prop};

/// Emit a document to Slidy HTML.
pub fn emit(doc: &Document) -> Result<ConversionResult<Vec<u8>>, EmitError> {
    emit_with_options(doc, &EmitOptions::default())
}

/// Emit a document to Slidy HTML with options.
...
<title>{}</title>
<link rel="stylesheet" type="text/css" href="https://www.w3.org/Talks/Tools/Slidy2/styles/slidy.css" />
<script src="https://www.w3.org/Talks/Tools/Slidy2/scripts/slidy.js" type="text/javascript"></script>
</head>
<body>
"#,
        escape_html(title)
